...
class GenreFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.i("TAG!!!", genres.size.toString())

        val itemAdapter = GenreAdapter(genres)

        val userList = activity!!.findViewById<RecyclerView>(R.id.genre_list_recycler_view)
    ...
    private fun scanDeviceForGenres(): ArrayList<Genre> {
        ...
        val sortOrder =
            MediaStore.Audio.Genres.NAME + " COLLATE LOCALIZED ASC"
